...
def train(args):
  ...
  wandb.run.name = '/batch_size/'+str(args.batch_size)+'/learning_rate/'+ str(args.learning_rate)+'/epochs/'+str(args.epochs)+ '/optimizer/'+str(args.optimizer)+ '/hidden_layer_count/'+str(args.hidden_layer_count)+'/size_hidden_layers/'+str(args.size_hidden_layers)+ '/activation/'+str(args.activation)+'/weight_decay/'+str(args.weight_decay)+'/weight_initializations/'+str(args.weight_initializations)+'/loss/'+str(args.loss)
...
if __name__ == '__main__':
  ...
  parser.add_argument("-w_d", "--weight_decay", default=0.05, type=float)
  parser.add_argument("-w_i", "--weight_initializations", default="random", choices=["random", "Xavier"])
  parser.add_argument("-nhl", "--hidden_layer_count", default=3, type=int)
  parser.add_argument("-sz", "--size_hidden_layers", default=512, type=int)
...
# !python train14.py -wp myproject -we ed22s009 -d mnist -e 5 -b 128 -lr 0.001 -nhl 3 -sz 128 -a ReLU -w_i Xavier -w_d 0 -o adam -l cross_entropy
